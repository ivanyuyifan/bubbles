...
for x in range(13):
    ...
    # 将字典中键所对应的值设置为0
    subtitleDict[segment_range] = 0

# TODO for循环遍历字典subtitlesDict所有的键
for subtitle in subtitleDict.keys():
