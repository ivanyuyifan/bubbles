...
#这里我是自建了excel，前提是文章都已经被整理好，方便一键粘贴
articles_BBC = pd.read_excel('/Users/fafaya/Desktop/Paris Olympics/Paris Olympics/BBC_content.xlsx')
...
for i in range(len(articles_BBC)):
    content = articles_BBC.loc[i]['content']
...
result.to_excel('/Users/fafaya/Desktop/Paris Olympics/Paris Olympics/BBC_content_result.xlsx')
